...
const About = () => {
  ...
  return (
    <View style={styles.aboutContainer}>
      <Text style={styles.mainHeader}> Amar Kumar Swain </Text>
      ...
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity
          ...
          <Image
            style={styles.iconStyle}
            source={{
              uri: "https://cdn-icons-png.flaticon.com/128/174/174848.png",
            }}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            style={styles.iconStyle}
            source={{
              uri: "https://cdn-icons-png.flaticon.com/128/174/174857.png",
            }}
          />
        </TouchableOpacity>
      </View>
